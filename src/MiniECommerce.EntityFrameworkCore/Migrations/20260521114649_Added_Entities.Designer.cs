...
namespace MiniECommerce.Migrations
{
    ...
    [Migration("20260521114649_Added_Entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniECommerce.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("MiniECommerce.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MiniECommerce.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MiniECommerce.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MiniECommerce.Orders.OrderItem", b =>
                {
                    b.HasOne("MiniECommerce.Orders.Order", null)
                        .WithMany("Items")
