...
public class MiniECommerceDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MiniECommerceDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
